...
const String SOCIAL_SHARE_MESSAGE =
    "Bonyeza Kazi is brilliant! You can find range of service providers(electricians,beauticians,health care workers and more). Its easy to use. Download the app using this link";
